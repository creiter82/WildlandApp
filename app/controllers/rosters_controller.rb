class RostersController < ApplicationController
  ...
  def show
    ...
    @ffs = User.joins(:availabilities).where(availabilities: { availability_position_id: @firefighter.id, roster_id: @roster.id }).order(Availability.arel_table[:created_at]).sort_by{ |t| t.deployments.from_this_year.count }
