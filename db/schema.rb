...
ActiveRecord::Schema.define(version: 20180416022116) do
  ...
  create_table "availabilities", force: :cascade do |t|
    ...
    t.integer  "availability_position_id"
  end
  ...
  create_table "team_deployments", force: :cascade do |t|
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at",                             null: false
    t.datetime "updated_at",                             null: false
    t.integer  "deployments_count",      default: 0,     null: false
    t.string   "roles"
